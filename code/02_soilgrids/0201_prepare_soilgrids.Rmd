...
# Point of interest for San Vito di Cadore study site
# Three tree locations provided by Enrico and slope calculated in QGIS with Gdal slope tool
sites = data.frame(id=c("P1", "P2", "P3"),
                   lon=c(12.20778, 12.207777, 12.207675),
                   lat=c(46.47071, 46.470775, 46.470439),
                   aspect=c(271, 280, 247),
                   slope=c(28, 21, 20)
                   )
