...
# #gdalcubes::write_ncdf(bands_cube,paste(outpath,"s2_bands_cube.nc",sep="/"),pack=T,overwrite=T)
...
##read s2 bands
nc_in=nc_open(paste(outpath,"s2_bands_cube.nc",sep="/"))
...
##read model results
mod_res=read.table(paste(model_path,sprintf("wb_indices_%s_%s.csv",pid,tree_species),sep="/"),header=T,sep=";")
mod_res$date=as.POSIXct(mod_res$date,tz="UTC")

plot(mod_res$date,mod_res$relawat,type="l",xlab="",ylab="Relawat",axes=F)
...
par(new=T)
plot(ts_single_clean$date,ts_single_clean$ndvi,type="o",ylim=c(-0.3,1.3),pch=20,lwd=2,col="red",axes=F,xlab="",ylab="")
lines(ts_single_clean$date,ts_single_clean$savi,type="o",pch=20,lwd=2,col="steelblue")
lines(ts_single_clean$date,ts_single_clean$evi,type="o",pch=20,lwd=2,col="darkgreen")
lines(ts_single_clean$date,ts_single_clean$ireci,type="o",pch=20,lwd=2,col="orange")
lines(ts_single_clean$date,ts_single_clean$ndrei,type="o",pch=20,lwd=2,col="black")

axis(side=4)
mtext(side=4,"Indices",line=3)
legend("bottomright",legend=c("NDVI","SAVI","EVI","IRECI","NDREI"),pch=20,lwd=2,col=c("red","steelblue","darkgreen","orange","black"))


##compare annual variation
mod_res$year=format(mod_res$date,format="%Y")
ts_single_clean["year"]=format(ts_single_clean$date,format="%Y")

boxplot(ts_single_clean$ndvi~ts_single_clean$year,xlab="",ylab="NDVI")
boxplot(ts_single_clean$savi~ts_single_clean$year,xlab="",ylab="SAVI")
boxplot(ts_single_clean$evi~ts_single_clean$year,xlab="",ylab="EVI")
boxplot(ts_single_clean$ireci~ts_single_clean$year,xlab="",ylab="IRECI")
boxplot(ts_single_clean$ndrei~ts_single_clean$year,xlab="",ylab="NDREI")
...
##monthly variation
mod_res$month=format(mod_res$date,format="%m")
ts_single_clean["month"]=format(ts_single_clean$date,format="%m")

boxplot(ts_single_clean$ndvi~ts_single_clean$month,xlab="",ylab="NDVI")
boxplot(ts_single_clean$savi~ts_single_clean$month,xlab="",ylab="SAVI")
boxplot(ts_single_clean$evi~ts_single_clean$month,xlab="",ylab="EVI")
boxplot(ts_single_clean$ireci~ts_single_clean$month,xlab="",ylab="IRECI")
boxplot(ts_single_clean$ndrei~ts_single_clean$month,xlab="",ylab="NDREI")

boxplot(mod_res$relawat~mod_res$month,xlab="",ylab="Relawat")
boxplot(mod_res$tdef~mod_res$month,xlab="",ylab="Tdef")
boxplot(mod_res$tratio~mod_res$month,xlab="",ylab="Tratio")
