...
##create a cube from local files
landsat_reg=sits::sits_cube(source="MPC",
                           collection="LANDSAT-C2-L2",
                           satellite="LANDSAT",
                           sensor="TM-ETM-OLI",
                           data_dir=sits_path_reg,
                           progress=F
                           )
...
ndvi_series["month"]=format(ndvi_series$Index,format="%m")
savi_series["month"]=format(savi_series$Index,format="%m")
evi_series["month"]=format(evi_series$Index,format="%m")

boxplot(ndvi_series$NDVI~ndvi_series$month,xlab="",ylab="NDVI")
boxplot(savi_series$SAVI~savi_series$month,xlab="",ylab="SAVI")
boxplot(evi_series$EVI~evi_series$month,xlab="",ylab="EVI")
